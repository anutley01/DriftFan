...
public class SQLHelper extends SQLiteOpenHelper {
   ...
   public static final String CREATE_HOTEL_DUNLAOGHAIRE = "CREATE TABLE IF NOT EXISTS " + TABLE_HOTEL_DUNLAOGHAIRE + "("
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(insertHotelMondello("Radisson Blue Cork", "+353 21 429 7000", 51.906362, -8.357155, "B", "Watergrasshill"));
    ...
    /*public boolean insertData(String hotelName, String hotelPhone, String latitude, String longitude, String price, String near_to){
        ...
        long result = sqLiteDatabase.insert(TABLE_HOTEL_MONDELLO, null, contentValues);
        if (result == -1){
            return false;
        } else{
            return true;
   ...
   /* public String insertBulding(String hotelName, String phone, double latitude, double longitude, String price, String nearTo) {
        String insertHotelToDB = "INSERT INTO " + TABLE_HOTEL_MONDELLO
                + " (" + HOTEL_NAME + "," + PHONE + "," + LATITUDE + "," + LONGITUDE + "," + PRICE + "," + NEAR_TO
