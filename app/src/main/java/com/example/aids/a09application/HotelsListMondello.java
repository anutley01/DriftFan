...
public class HotelsListMondello extends AppCompatActivity {
    ListView hotelList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<>(HotelsListMondello.this, android.R.layout.simple_list_item_1, buildingNames);
